...
function SudsClient(_options) {
  ...
  var config = extend({
    ...
    envelopeBegin: '<?xml version="1.0" encoding="utf-8"?><soap:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.motoincontro.com/"><soap:Body>',
  ...
  this.invoke = function(_soapAction,_body,_callback) {    
    ...
    xhr.open('POST',config.endpoint);
		...
		var header = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.motoincontro.com/">   <soapenv:Header/>    <soapenv:Body>            ';
		var footer = '       </soapenv:Body> </soapenv:Envelope>';
		//xhr.send(config.envelopeBegin+body+config.envelopeEnd);
		
		var msg = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.motoincontro.com/">   <soapenv:Header/>    <soapenv:Body>        <ws:search>            <search>BMW</search>       </ws:search></soapenv:Body> </soapenv:Envelope>';
		var msg2 = 	header+body+footer;	  
		xhr.send(msg2);
